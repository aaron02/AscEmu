...
struct Summary
{
    size_t any{ 0 }, creatures{ 0 }, gameobjects{ 0 }, dynamics{ 0 }, players{ 0 }, pets{ 0 }, corpses{ 0 }, transporters{ 0 }, total{ 0 };
};
