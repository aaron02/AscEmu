...
enum CREATURE_TYPE_MASK
{
    CREATURE_TYPE_MASK_NONE                     = 0x00000000,
    CREATURE_TYPE_MASK_SUMMON                   = 0x00000001,
    CREATURE_TYPE_MASK_MINION                   = 0x00000002,
    CREATURE_TYPE_MASK_GUARDIAN                 = 0x00000004,
    CREATURE_TYPE_MASK_TOTEM                    = 0x00000008,
    CREATURE_TYPE_MASK_PET                      = 0x00000010,
    CREATURE_TYPE_MASK_VEHICLE                  = 0x00000020,
    CREATURE_TYPE_MASK_PUPPET                   = 0x00000040,
    CREATURE_TYPE_MASK_HUNTER_PET               = 0x00000080,
    CREATURE_TYPE_MASK_CONTROLABLE_GUARDIAN     = 0x00000100,
    CREATURE_TYPE_MASK_ACCESSORY                = 0x00000200
};
